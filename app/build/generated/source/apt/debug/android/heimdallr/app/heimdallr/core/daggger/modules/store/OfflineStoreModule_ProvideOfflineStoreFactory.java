...
public final class OfflineStoreModule_ProvideOfflineStoreFactory implements Factory<OfflineStore> {
  ...
  public OfflineStoreModule_ProvideOfflineStoreFactory(
      OfflineStoreModule module, Provider<RoomManager> roomManagerProvider) {
    this.module = module;
  ...
  public OfflineStore get() {
    return Preconditions.checkNotNull(
        module.provideOfflineStore(roomManagerProvider.get()),
        "Cannot return null from a non-@Nullable @Provides method");
  }

  public static OfflineStoreModule_ProvideOfflineStoreFactory create(
      OfflineStoreModule module, Provider<RoomManager> roomManagerProvider) {
    return new OfflineStoreModule_ProvideOfflineStoreFactory(module, roomManagerProvider);
  }

  public static OfflineStore proxyProvideOfflineStore(
      OfflineStoreModule instance, RoomManager roomManager) {
    return Preconditions.checkNotNull(
        instance.provideOfflineStore(roomManager),
        "Cannot return null from a non-@Nullable @Provides method");
  }
}
