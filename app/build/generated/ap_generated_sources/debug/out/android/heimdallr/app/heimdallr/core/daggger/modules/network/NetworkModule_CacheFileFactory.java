...
public final class NetworkModule_CacheFileFactory implements Factory<File> {
  ...
  public File get() {
    return Preconditions.checkNotNull(
        module.cacheFile(contextProvider.get()),
        "Cannot return null from a non-@Nullable @Provides method");
  }

  public static NetworkModule_CacheFileFactory create(
      NetworkModule module, Provider<Context> contextProvider) {
    return new NetworkModule_CacheFileFactory(module, contextProvider);
  }

  public static File proxyCacheFile(NetworkModule instance, Context context) {
    return Preconditions.checkNotNull(
        instance.cacheFile(context), "Cannot return null from a non-@Nullable @Provides method");
  }
}
