...
public final class RetrofitModule_ProvideRetrofitFactory implements Factory<Retrofit> {
  ...
  public Retrofit get() {
    return Preconditions.checkNotNull(
        module.provideRetrofit(okHttpClientProvider.get(), callAdapterFactoryProvider.get()),
  ...
  public static RetrofitModule_ProvideRetrofitFactory create(
    ...
    return new RetrofitModule_ProvideRetrofitFactory(
        module, okHttpClientProvider, callAdapterFactoryProvider);
  }
  ...
  public static Retrofit proxyProvideRetrofit(
    ...
    return Preconditions.checkNotNull(
        instance.provideRetrofit(okHttpClient, callAdapterFactory),
        "Cannot return null from a non-@Nullable @Provides method");
  }
}
